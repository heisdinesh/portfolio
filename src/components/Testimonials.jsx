        ...
        <section className='flex pt-12 md:pt-0 text-white md:w-1/2'>
            <div className="flex flex-col justify-evenly items-center ">
                <div className='flex flex-col    '>
                    <p className="text-4xl md:text-6xl text-white font-bold ">Available for opportunities</p>
                    {/* <div className=''> */}
                    <p className='text-md font-semibold pt-8'>Have an exciting project you need help with?</p>
                    <p className='text-md font-semibold'>Send me an email or contact me via instant message!</p>
                    {/* </div> */}
                </div>
                <div>
                    <p className="text-2xl text-white pt-8 md:pt-0">heisdinesh18@gmail.com</p>
                    ...
                    <div className="flex justify-evenly pt-8 pb-8 md:pb-0 ">
                        ...
                        <Link to={`/`} className='text-2xl'><FaBehance /></Link>
                    </div>
                </div>
            </div>
        </section>
...
Great to work with and has displayed leadership qualities in his Work!!
Wishing him all the Success in the Future</p>
...
<p className='text-justify px-8'>CTO of HealthSphere</p>
                ...
                <div className='h-1/2 bg-green-700'>
